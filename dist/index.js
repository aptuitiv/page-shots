...
var config = {
  ...
  processClip(clip) {
    ...
    if (objectValueIsNumberOrNumberString(clip, "x") && objectValueIsNumberOrNumberString(clip, "y") && objectValueIsNumberOrNumberString(clip, "w") && objectValueIsNumberOrNumberString(clip, "h")) {
...
var thisPackageJson = fs2.readJsonSync(
...
program.version(thisPackageJson.version).description(thisPackageJson.description).option(
  ...
  "-D, --delay <integer>",
  `The number of milliseconds to delay after loading before taking a picture of the page. Can not be greater than ${config_default.maxDelay}.`
).option(
  "-d, --dir <string>",
