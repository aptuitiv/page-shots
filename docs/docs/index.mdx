...
If you need to hide chat widgets that are present on the page then you can use the `hideSelector` option to hide the chat widget. See the [Hiding elements](#hiding-elements) section for more information.
